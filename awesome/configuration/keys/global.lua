...
local globalKeys =
  ...
  -- Alt-tab
    ...
    -- -- No idea why would i need backwards tab
    -- awful.key(
    --   {altkey, 'Control'},
    --   'Tab',
    --   function()
  ...
  -- Media keys
    awful.key(
      ...
      {description = 'Play/Pause Media', group = 'launcher'}
    ),
    awful.key(
      {},
      'XF86AudioNext',
      ...
      {description = 'Next Media', group = 'launcher'}
    ),
    awful.key(
      {},
      'XF86AudioPrev',
  ...
  -- Some columns/clients manipulation sh!t
    awful.key(
      {modkey, 'Shift'},
      'Left',
      function()
  ...
  -- Switch between layouts (floating, tiled, fullscreen)
    awful.key(
      {modkey},
      'space',
      function()
