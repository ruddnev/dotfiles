...
local textclock = wibox.widget {
  -- format = '<span font="Roboto Mono 12">%A, %B %e  </span><span font="Roboto Mono Bold 14"> %k:%M:%S</span>',
  -- -- format = '%d.%m.%Y - %H:%M:%S',
  -- refresh = 1,
  -- -- forced_height = 30,
  -- widget = wibox.widget.textclock
    ...
    -- id = 'id_text',
    format = '<span font="Roboto Mono 12">%A, %B %e  </span><span font="Roboto Mono Bold 13"> %k:%M:%S</span>',
    refresh = 1,
    -- align  = 'center',
    valign = 'center',
    widget = wibox.widget.textclock
